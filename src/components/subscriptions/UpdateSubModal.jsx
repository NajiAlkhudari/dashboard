...
const UpdateSubModal = ({ isOpen, onClose, onUpdateSub, initialData }) => {
      ...
      <div className="max-h-[calc(100vh-100px)] overflow-y-auto p-6">
        <Formik
          initialValues={{
            ...
            costPermonth: initialData.costPermonth || 0,
            clientId: initialData.clientId || "",
            agentsDtos: [
              {
                agentId: initialData.agentId || null,
                agentPercentage: initialData.agentPercentage ||0,
                ...
                {({ push, remove }) => (
                  <div className="space-y-3">
                    {values.agentsDtos.map((agent, index) => (
                      <div
                        key={index}
                        className="border p-3 rounded-lg bg-background"
                      >
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        push({ agentId: null, agentPercentage: 0, notes: "" })
                      }
