...
export const postCompany = createAsyncThunk ("companies/postCompaniy" , async (postData , {rejectWithValue})=>{
  const token = Cookies.get('token');

  try{

      const response =  await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/api/Companies` , postData ,{
          headers :  {
              Authorization : `Bearer ${token}`,
